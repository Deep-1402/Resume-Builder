...
function Education() {
    let Edu = document.createElement('textarea');
    Edu.classList.add('form-control');
    Edu.classList.add('edField');
    Edu.setAttribute('rows', 3);
    Edu.classList.add('mt-2')
    
    let edOb = document.getElementById('ed');
    let edAddButtonOb = document.getElementById('edAddButton');

    edOb.insertBefore(Edu, edAddButtonOb);
}

function Certifications() {
    let Certi = document.createElement('textarea');
    Certi.classList.add('form-control');
    Certi.classList.add('ceField');
    Certi.setAttribute('rows', 3);
    Certi.classList.add('mt-2')
    
    let ceOb = document.getElementById('ce');
    let ceAddButtonOb = document.getElementById('ceAddButton');
    
    ceOb.insertBefore(Certi, ceAddButtonOb);
}

function Experience() {
    let Exprc = document.createElement('textarea');
    Exprc.classList.add('form-control');
    Exprc.classList.add('weField');
    Exprc.setAttribute('rows', 3);
    Exprc.classList.add('mt-2')

    let weOb = document.getElementById('we');
    let weAddButtonOb = document.getElementById('weAddButton');

    weOb.insertBefore(Exprc, weAddButtonOb);
}
